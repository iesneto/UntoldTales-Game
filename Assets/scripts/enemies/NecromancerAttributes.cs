...
public class NecromancerAttributes : EnemyAttributes
{
    protected override void Awake()
    {
        ...
        zombieScr = GetComponent<NecromancerBehavior>();
        //maxHealth = 90;
    ...
    public override void Disapear(bool status)
    {
        for(int i = 0; i < renderList.Length; i++)
        {
            myRender.enabled = !status;
        }
    }
}
