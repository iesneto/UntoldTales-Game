...
public class SwampEntBehavior : ZombieBehavior {

    public GameObject entangleSpellPrefab;
    public Transform specialPosition;
    public float entangleSpeed;
    ...
    protected override void Start()
    {
        ...
        attributes = GetComponent<SwampEntAttributes>();
    ...
    {
        Instantiate(entangleSpellPrefab, specialPosition.position, specialPosition.rotation);
